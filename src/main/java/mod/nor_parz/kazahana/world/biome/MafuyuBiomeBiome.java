...
public class MafuyuBiomeBiome extends KazahanaModElements.ModElement {
	@ObjectHolder("kazahana:mafuyu_biome")
	public static final CustomBiome biome = null;
	public MafuyuBiomeBiome(KazahanaModElements instance) {
		super(instance, 37);
	}
