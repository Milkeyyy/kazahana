...
import mod.nor_parz.kazahana.item.TestItem;
...
public class TestDimension extends KazahanaModElements.ModElement {
	@ObjectHolder("kazahana:test")
	public static final ModDimension dimension = null;
	@ObjectHolder("kazahana:test_portal")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("test"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("kazahana:test")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("kazahana:test"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("kazahana:test"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("snowy_tundra")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("kazahana:test_biome")),};
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = TestDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("test_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "test_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = TestDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
